...
_C.MAC.DIM = 512
_C.MAC.EMBD_DIM = 300
_C.MAC.TRAINED_EMBD_PATH = ''     # empty string for random init (no loading)
_C.MAC.KNOW_DIM = 1024
_C.MAC.ENC_INPUT_DROPOUT = 0.15
_C.MAC.STEM_DROPOUT = 0.18
_C.MAC.STEM_FILTER_SIZE = 3
_C.MAC.STEM_PAD = 1
_C.MAC.STEM_DROPOUT = 0.18
...
_C.DATALOADER.FEATURES_PATH = "/datasets/CLEVR_v1.0"
...
# ---------------------------------------------------------------------------- #
_C.SAVE_PATH = 'checkpoint/mac_12'
...
# ---------------------------------------------------------------------------- #
_C.COMET = CN()
_C.COMET.EXPERIMENT_NAME = 'MAC 12'
_C.COMET.PROJECT_NAME = 'mac-clevr'
